...
export const Payment = () => {
  ...
  const clickCheckout = (e) => {
    e.preventDefault();
    setPaymentMsg("Payment success and order placed successfully");
                      ...
                      <MDBCol lg="7">
                        <MDBTypography tag="h5">
                          <a href="#!" className="text-body">
                            <MDBIcon fas icon="long-arrow-alt-left me-2" /> Your
                            Products
                          </a>
                        </MDBTypography>
                        ...
                        <MDBCard className="bg-primary text-white rounded-3">
                          <MDBCardBody>
                            ...
                            <div className="d-flex justify-content-between">
                              ...
                              <p className="mb-2">${data.total + 20}</p>
                            </div>
